...
workflow HaplotypeCallerGvcf_GATK4 {
  ...
  File ref_fasta = "s3://" + src_bucket_name + "/reference/Mus_musculus.GRCm39.dna.toplevel.fa"    File ref_fasta_index="s3://" + src_bucket_name + "/broad-references/hg38/v0/Homo_sapiens_assembly38.fasta.fai"
