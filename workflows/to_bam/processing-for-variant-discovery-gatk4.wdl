...
workflow PreProcessingForVariantDiscovery_GATK4 {
  ...
  # END OF FIRST HALF OF OLD WORKFLOW

  # Now we will run the haplotypecaller-gvcf-gatk4 workflow but seperate into calls
  # to allow for the scatter-gather to be done in parallel
  # we will need these inputs from the previous workflow         
  # File input_bam
...
# Tasks specifc to haplotypecaller-gvcf-gatk4 workflow
# we are merging this from another file wit hthe following info
